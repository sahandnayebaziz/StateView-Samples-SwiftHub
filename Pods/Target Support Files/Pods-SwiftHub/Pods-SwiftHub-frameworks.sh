...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AuthenticationViewController/AuthenticationViewController.framework"
  install_framework "$BUILT_PRODUCTS_DIR/BRYXBanner/BRYXBanner.framework"
  install_framework "$BUILT_PRODUCTS_DIR/PromiseKit/PromiseKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SnapKit/SnapKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/StateView/StateView.framework"
